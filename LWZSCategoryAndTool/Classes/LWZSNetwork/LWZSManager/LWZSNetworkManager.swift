...
class LWZSNetworkManager: NSObject {
    //MARK: 单例
    static public let shared: LWZSNetworkManager = {
        let instance: LWZSNetworkManager = LWZSNetworkManager()
        return instance
    }()
    //MARK: 成功回调
    ...
    //        return requestData
        ...
        private func headerParams(parameters: [String : Any]) -> [String : String] {
            ...
            let _nsign = array.lwzs_md5(andKey: "v__s_k_=xinyong234@21@#$fasd")
